...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MscBots/Yildiz",
)
KANAL = getenv(
    "KANAL", "AikoCall"
)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/608001bdce5b396b50ea2.jpg")
