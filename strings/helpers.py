...
~ 𝖭𝗈𝗍 : 𝖯𝗌̧𝖺𝗒𝗅𝗂𝗌𝗍𝗂𝗇𝗂𝗓𝗂 𝗈𝗒𝗇𝖺𝗍𝗆𝖺𝗄 𝗂𝖼̧𝗂𝗇 /oynat 𝗒𝖺𝗓ı𝗉 𝖫𝗂𝗌𝗍𝖾𝗆𝗂 𝗈𝗒𝗇𝖺𝗍 𝖻𝗎𝗍𝗈𝗇𝗎𝗇𝗎 𝗄𝗎𝗅𝗅𝖺𝗇ı𝗇 ...
...
» /bakim  -> [ botu bakıma alır ]
» /guncelle  -> [ botu günceller ]
...
» /reklam 
-pin :  Mesajı Sabitler .
-pinloud : Mesajı Bildirimle Sabitler .
-user : Kullanıcılara Gönderir .
-assistant : Asistan Hesabından Gönderir .

Kullanım: /reklam -user -assistant -pin Merhaba
**"""
